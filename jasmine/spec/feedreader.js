...
$(function () {
  ...
  describe('Initial Entries', function () {
     ...
     */
    it('should have at least a single .entry element in .feed container', function(done) {
  ...
  describe('New Feed Selection', function () {
     ...
     */
    it('should ensure when a new feed is loaded and the content changes', function (done) {
